...
class Booking_Room():
    def __init__(self,root):
       ...
       # self.root.wm_iconbitmap(r'C:\Users\LENOVO\Downloads\1641806470225Hotel-Management-Sytem-Project/icon.png')
        ...
        conn=mysql.connector.connect(host="localhost",username="root",password="rakesh9339",database="mydata")
    ...
    def cont_fetch(self):
        if self.var_mobile.get()=="":
            ...
            conn=mysql.connector.connect(host="localhost",user="root",password="rakesh9339",database="mydata")
            my_cursor=conn.cursor()
